...
class BootLoader extends Scene {
  ...
  loadImages() {
    ...
    this.load.image('blackout-menuitem', 'assets/images/blackout-menuitem.png')
    this.load.image('classic-menuitem', 'assets/images/classic-menuitem.png')
    this.load.image('crazy-8-menuitem', 'assets/images/crazy-8-menuitem.png')
    this.load.image('five-spot-menuitem', 'assets/images/five-spot-menuitem.png')
    this.load.image('happy-h-menuitem', 'assets/images/happy-h-menuitem.png')
    this.load.image('x-marks-menuitem', 'assets/images/x-marks-menuitem.png')
